  ...
  const statCards = [
    {
      icon: Briefcase,
      label: 'Total Offers',
      value: loading ? 'Loading...' : stats.totalOffers.toLocaleString(),
      change: '+12%',
    ...
    },
    {
      ...
      value: loading ? 'Loading...' : `${stats.placementRate.toFixed(1)}%`,
      change: '+5%',
      color: 'text-blue-400'
    },
    {
      icon: Users,
      label: 'Avg Package',
      value: loading ? 'Loading...' : `₹${stats.avgPackage.toFixed(1)}L`,
      change: '+8%',
    ...
    },
    {
      ...
      value: loading ? 'Loading...' : stats.totalCompanies.toLocaleString(),
      change: '+15%',
      color: 'text-cyan-400'
    }
  ];

...
const CollegeDashboard = () => {
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <RechartsPieChart>
                        ...
                        <Tooltip
                          contentStyle={{
                            backgroundColor: 'rgba(252, 245, 245, 0.8)',
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={branchPerformance} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
                        <CartesianGrid strokeDasharray="3 3" stroke="rgba(10, 6, 6, 0.1)" />
                        <XAxis 
                          dataKey="branch" 
                          stroke="#888"
                          fontSize={12}
                        ...
                        <Tooltip
                          contentStyle={{
                            backgroundColor: 'rgba(12, 8, 8, 0.8)',
                            border: '1px solid rgba(255,255,255,0.2)',
                            borderRadius: '8px',
                            color: 'white'
                          }}
  ...
  <motion.div
    ...
    className="w-full"
  >
    <Card className="glass-effect border-white/10 w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
      ...
      <CardContent>
        <div className="space-y-4 max-h-[90vh] overflow-y-auto w-full">
          {branchPerformance.map((branch, index) => (
            <div 
              key={index} 
              className="p-4 rounded-lg bg-gradient-to-r from-gray-800/50 to-gray-700/30 border border-gray-600/30 w-full"
            >
              <div className="flex justify-between items-start mb-3">
                ...
                <Badge 
                  variant={
                    branch.efficiency === 'High' ? 'default' : 
                    branch.efficiency === 'Medium' ? 'secondary' : 
                    'destructive'
                  }
                >
